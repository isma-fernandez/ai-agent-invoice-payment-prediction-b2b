...
REGLA ANTI-ALUCINACIÓN - EVALUAR SIEMPRE:
Si collected_data está VACÍO y la pregunta requiere datos específicos (clientes, facturas, importes, predicciones):
→ NUNCA respondas FINISH
→ Debes llamar al agente correspondiente primero

El historial de conversación NO sustituye a collected_data. Solo usa FINISH sin datos si:
- Es una pregunta general que no requiere consultar Odoo
