...
4. GRÁFICOS PERSONALIZADOS:
   - generate_chart(chart_type, title, data): Solo si necesitas un gráfico diferente

NOTA: Todas las herramientas de análisis ya incluyen gráficos automáticamente en su respuesta.
No necesitas llamar a generate_chart a menos que quieras un gráfico personalizado adicional.
